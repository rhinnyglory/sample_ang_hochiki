...
module.exports = "<div class=\"box box-primary\">\n    <div class=\"box-header with-border\">\n        <h3 class=\"box-title\">Feedback</h3>\n    </div>\n    <div class=\"box-body box-profile\">\n        <h3 class=\"profile-username text-center\">Feedback</h3>\n    </div>\n    <div class=\"box-body\">\n        <form class=\"form-horizontal\">\n            <div class=\"form-group\">\n                <label for=\"inputName\" class=\"col-sm-4 control-label\">Name :</label>\n                <div class=\"col-sm-6\">\n                    <label class=\"control-label\">{{feedDet.name}}</label>\n                </div>\n            </div>\n            <div class=\"form-group\">\n                <label for=\"inputName\" class=\"col-sm-4 control-label\">Description :</label>\n                <div class=\"col-sm-6\">\n                    <label class=\"control-label\">{{feedDet.description}}</label>\n                </div>\n            </div>\n            <div class=\"form-group\">\n                <label for=\"inputEmail\" class=\"col-sm-4 control-label\">Customer Email :</label>\n                <div class=\"col-sm-6\">\n                    <label class=\"control-label\">{{feedDet.customerEmail}}</label>\n                </div>\n            </div>\n            <div class=\"form-group\">\n                <label for=\"inputName\" class=\"col-sm-4 control-label\">Customer Name :</label>\n                <div class=\"col-sm-6\">\n                    <label class=\"control-label\">{{feedDet.customerName}}</label>\n                </div>\n            </div>\n            <div class=\"box-footer\">\n                <div class=\"row\">\n                    <div class=\"col-sm-offset-4 col-sm-6\">\n                        <a routerLink=\"/feedback\" class=\"btn btn-sm btn-primary\">Close</a>\n                    </div>\n                </div>\n            </div>\n        </form>\n    </div>\n</div>"
    ...
    AddProductComponent.prototype.saveCompanyDetails = function (form) {
        ...
        if (!userId) {
            ...
            this.productService.createProduct(info).then(function (users) {
                ...
                __WEBPACK_IMPORTED_MODULE_4_jquery__('#success-alert').fadeTo(2000, 500).slideUp(500, function () {
                    __WEBPACK_IMPORTED_MODULE_4_jquery__('#success-alert').slideUp(500);
...
var AddUserComponent = /** @class */ (function () {
    ...
    AddUserComponent.prototype.saveUserDetails = function (form, user) {
        ...
        if (this.userId) {
            ...
            this.userService.updateUser(user).then(function (users) {
                // this.loaderService.display(false);
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.updateUser = function (user) {
        return this.httpcaller.httpcall(__WEBPACK_IMPORTED_MODULE_1__app_constantAPI__["a" /* ConstantApi */].userUpdate, 'put', user);
    };
